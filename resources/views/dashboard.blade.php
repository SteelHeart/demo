            ...
            <div class="table-responsive mb-0" data-list='{"valueNames": ["products-product", "products-stock", "products-price", "products-sales"]}' id="productsList">
                ...
                <tbody class="list">
                    ...
                    <td class="products-product">
                        ...
                        <!-- Image -->
                        <div class="avatar">
                            <img class="avatar-img rounded me-3" src="{{ asset('img/avatars/products/product-1.jpg') }}" alt="..." />
                        </div>
                    ...
                    <td class="products-product">
                        ...
                        <!-- Image -->
                        <div class="avatar">
                            <img class="avatar-img rounded me-3" src="{{ asset('img/avatars/products/product-2.jpg') }}" alt="..." />
                        </div>
                    ...
                    <td class="products-product">
                        ...
                        <!-- Image -->
                        <div class="avatar">
                            <img class="avatar-img rounded me-3" src="{{ asset('img/avatars/products/product-3.jpg') }}" alt="..." />
                        </div>
                    ...
                    <td class="products-product">
                        ...
                        <!-- Image -->
                        <div class="avatar">
                            <img class="avatar-img rounded me-3" src="{{ asset('img/avatars/products/product-4.jpg') }}" alt="..." />
                        </div>
